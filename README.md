...
## 👀 3D 다이어그램 바로 보기 — 클릭 한 번이면 됩니다

### ➡️ **[여기를 누르세요 → 3D 다이어그램 열기](https://withandwithout0094.github.io/2026-git-start/git-collab-3d.html)**

처음 오신 분을 위한 안내:

| 하고 싶은 것 | 방법 |
|---|---|
| 열기 | 위의 파란 링크를 **클릭** — 설치나 다운로드 없이 바로 열립니다 |
| 돌려보기 | 화면의 빈 곳을 **마우스로 누른 채 움직이면(드래그)** 그림이 회전합니다 |
| 크게/작게 | **마우스 휠**을 위아래로 굴립니다 |
| 처음 각도로 | 화면을 **더블클릭** 합니다 |
| 휴대폰 | 같은 링크를 열고 **손가락으로 끌면** 회전합니다 |

> ⚠️ 이 저장소 안의 `git-collab-3d.html` **파일을 직접 클릭하면 코드(설계도)가 보입니다.**
> 코드가 아니라 그림을 보시려면 반드시 **위의 파란 링크**로 접속하세요.
